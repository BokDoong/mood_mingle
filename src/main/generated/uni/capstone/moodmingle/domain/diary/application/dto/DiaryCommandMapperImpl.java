package uni.capstone.moodmingle.domain.diary.application.dto;
...
import uni.capstone.moodmingle.domain.diary.domain.Diary.DiaryBuilder;
import uni.capstone.moodmingle.domain.diary.domain.Diary.Emotion;
import uni.capstone.moodmingle.domain.diary.domain.Reply;
import uni.capstone.moodmingle.domain.diary.domain.Reply.ReplyBuilder;
import uni.capstone.moodmingle.domain.diary.domain.Reply.Type;
import uni.capstone.moodmingle.domain.member.domain.Member;

@Generated(
    value = "org.mapstruct.ap.MappingProcessor",
    date = "2025-03-31T20:21:09+0900",
