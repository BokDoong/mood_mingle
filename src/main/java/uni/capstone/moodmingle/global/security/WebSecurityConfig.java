package uni.capstone.moodmingle.global.security;
...
public class WebSecurityConfig {
    ...
    private static final String[] AUTH_WHITELIST = {"/api/v1/member/reissue", "/test/**", "/api/v1/member/basic-join", "/api/v1/member/basic-login"};
