package uni.capstone.moodmingle.global.security.handler;
...
import static uni.capstone.moodmingle.global.security.exception.code.AuthCode.*;
...
public class MingleAccessDeniedHandler implements AccessDeniedHandler {
    ...
    public JSONObject createAccessDeniedResponseInfo() {
        try {
            ...
            throw new BusinessException(ErrorCode.INVALID_JSON_TYPE);
        }
    }
}
